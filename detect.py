...
def run(model: str, width: int, height: int, num_threads: int,
    ...
    # Start capturing video input from the camera using Picamera2
    picam2 = Picamera2()
    preview_config = picam2.create_preview_configuration(main={"size": (width, height)}, transform=Transform(hflip=0, vflip=1))
